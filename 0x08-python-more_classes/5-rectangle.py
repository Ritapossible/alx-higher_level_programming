...
class Rectangle:
    ...
    so as to be able to recreate a new instance by using eval()
    ...
    @property
    def width(self):
        """ The getter width property """
        return self.__width

    @property
    def height(self):
        """ The getter height property """
        return self.__height

    @width.setter
    def width(self, value):
        """ The setter width property """
