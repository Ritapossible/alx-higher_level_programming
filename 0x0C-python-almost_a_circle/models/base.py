...
class Base:
    ...
    Attributes     
    __nb_objects (int): The num of instantiated Bases.
    """
    ...
    def from_json_string(json_string):
        ...
        Returns:
            If json_string is None or empty - always return an empty list.
    ...
    def load_from_file_csv(cls):
        ...
        Returns:
            While the file does not exist - output an empty list.
