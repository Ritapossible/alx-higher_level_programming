#!/usr/bin/python3
"""Defines unittests for models/square.py file.
Unittest classes:
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests for testing __str__ and display the methods of Square class."""

    @staticmethod
    def capture_stdout(sq, method):
        """Captures and returns text printed to the stdout.
        Args:
            sq (Square): The Square ot print to stdout.
            method (str): The method to run on sq.
        Returns:
            The text printed to stdout by calling the method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests for testing the update args method of the Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittests for testing the update kwargs method of Square class."""
