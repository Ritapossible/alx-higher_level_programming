#!/usr/bin/python3
"""This is the module contains a class that defines a square.
In the Square class we initialize each object by the
__init__ method with the private instance variable called
__size that takes the size variable's value passed as
argument. It also checks if the size arg has a valid value.
"""
